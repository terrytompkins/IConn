...
export default class Tech extends Vue {
  ...
  public prepareRemove(instance: ITech): void {
  ...
  public removeTech(): void {
    this.techService()
      ...
      .then(() => {
        const message = this.$t('iConnApp.tech.deleted', { param: this.removeId });
